...
featuredImg: 'elyk-project-banner-large.jpg'
embeddedImgs:
  - elyk-project-image.jpg
  - elyk-lesson-plan.jpg
---

import { getImage, GatsbyImage } from 'gatsby-plugin-image';
import EmbeddedPostImage from '../components/EmbeddedPostImage';

# GatsbyJS Consulting for Elyk Innovation

Elyk Innovation (Elyk) is a web development small business based in Jacksonville, FL. They specialize in building accessible websites that help grow their clients' businesses and reach their target audiences. Since the day-to-day needs of a growing business can change frequently, Elyk's clients often want control of their content to make edits on the fly. This requirement made choosing WordPress as their CMS of choice an obvious decision. Elyk gets access to a huge ecosystem of plugins to develop websites rapidly, and their clients can be trained to make common updates themselves.
...
I proposed a solution to alleviate these issues while allowing them to continue using the CMS they had grown experienced with over the years.
...
<div>
  <EmbeddedPostImage
    ...
    layout="fullWidth"
    placeholder="blurred"
    caption="A segment of Elyk's new home page"
    alt=""
  />
</div>
...
This tech stack composing Javascript with APIs and markup (the JAM Stack) was new to the Elyk team and I wasn't going to leave them hanging, so alongside building the site I created an onboarding lesson plan.
...
<div>
  <EmbeddedPostImage
    ...
    layout="fullWidth"
    placeholder="blurred"
    caption="An overview of the lesson plan I created for Elyk"
    alt=""
  />
</div>
